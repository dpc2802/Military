...
const oldTotal = '    totalAmount: numeric("total_amount", { precision: 12, scale: 2 }).notNull(),';
const newTrackingFields = `    totalAmount: numeric("total_amount", { precision: 12, scale: 2 }).notNull(),
...
console.log("Added tracking fields to schema");
